...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.b_tockha = QPushButton(".", self)
        self.hbox_fourth.addWidget(self.b_tockha)

        self.b_umnojenie = QPushButton("*", self)
        self.hbox_fourth.addWidget(self.b_umnojenie)

        self.b_delenie = QPushButton("/", self)
        self.hbox_third.addWidget(self.b_delenie)
